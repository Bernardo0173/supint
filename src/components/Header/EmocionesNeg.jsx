...
function EmocionesNeg({ isOpen, title, content, actions, onDelete, openPanel }) {
        ...
        <div>
          ...
          >
            <div className="expandable-content">
              ...
              <div key = "99" className='action-item' onClick={openPanel} >4. Mandar mensajes a agentes 📧</div>
            </div>
          </CSSTransition>
        </div>
      )}
